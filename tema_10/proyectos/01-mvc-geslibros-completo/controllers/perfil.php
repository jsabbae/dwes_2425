...
class Perfil extends Controller
{
    ...
    */
    public function update()
    {
        ...
        $cuerpo_mensaje = "Mensaje: Su perfil ha sido modificado, pongase en contacto con Geslisbros si no fue usted el que hizo la modificación\n";

        $this->enviarEmail("Geslibros", $email, "Modificación de su perfil", $cuerpo_mensaje);
    ...
    */
    public function update_pass()
    {
        ...
        //  enviar email de confirmación
        $cuerpo_mensaje = "Mensaje: Su password ha sido modificado, pongase en contacto con Geslisbros si no fue usted el que hizo la modificación\n";

        $this->enviarEmail("Geslibros", $user->email, "Modificación de su password", $cuerpo_mensaje);
    ...
    */
    public function delete($param = [])
    {
        ...
        //  enviar email de confirmación
        $cuerpo_mensaje = "Mensaje: Su cuenta ha sido eliminada, pongase en contacto con Geslisbros si no fue usted el que hizo la eliminación\n";

        $this->enviarEmail("Geslibros", $user->email, "Eliminación de la cuenta", $cuerpo_mensaje);
  ...
  */
    function enviarEmail($name, $email, $subject, $message)
    {
        ...
        try {
            ...
            $mail->setFrom(SMTP_USER, 'Geslibros');
