...
*/
  ...
  */
    ...
    */
    ...
    /*
        método: validateForeignKeyAutorImportar($autor_nombre)
    ...
    */
    public function validateForeignKeyAutorImportar(string $autor_nombre)
    {
        try {
            $sql = "SELECT 
                        id
            ...
            $conexion = $this->db->connect();
            $stmt = $conexion->prepare($sql);
            $autor_nombre_trimmed = trim($autor_nombre);     //  Se necesita crear la variable para que funcione el bindParam()
            $stmt->bindParam(':autor_nombre', $autor_nombre_trimmed, PDO::PARAM_STR);
            $stmt->execute();
    ...
    */
    ...
    /*
        método: validateForeignKeyEditorialImportar($editorial_nombre)

        descripción: valida el editorial_id seleccionadoel archivo al importar. Que exista en la tabla editoriales

        @param: 
            - $editorial_id

    */
    public function validateForeignKeyEditorialImportar(string $editorial_nombre)
    {
        try {
            $sql = "SELECT 
                    id
        ...
        ";
            ...
            $conexion = $this->db->connect();
            $stmt = $conexion->prepare($sql);
            $editorial_nombre_trimmed = trim($editorial_nombre);     //  Se necesita crear la variable para que funcione el bindParam()
            $stmt->bindParam(':editorial_nombre', $editorial_nombre_trimmed, PDO::PARAM_STR);
            $stmt->execute();
  ...
  */
    ...
    /*
        ...
        método: validateForeignKeyGeneroImportar($generos_nombre)

        descripción: valida el generos_name seleccionado el archivo al importar. Que exista en la tabla generos

        @param: 
            - $generos_nombre

    */
    public function validateForeignKeyGeneroImportar(string $genero_nombre)
    {
        try {
            $sql = "SELECT 
                    id
        ...
        ";
            ...
            $conexion = $this->db->connect();
            $stmt = $conexion->prepare($sql);
            $genero_nombre_trimmed = trim($genero_nombre);  //  Se necesita crear la variable para que funcione el bindParam()
            $stmt->bindParam(':genero_nombre', $genero_nombre_trimmed, PDO::PARAM_STR);
            $stmt->execute();
    ...
    public function import($libros)
    {
        ...
        try {
            ...
            foreach ($libros as $libro) {
                ...
                $stmt->bindParam(':autor_id', $libro[1], PDO::PARAM_STR, 50);
                $stmt->bindParam(':editorial_id', $libro[2], PDO::PARAM_STR, 50);
                $stmt->bindParam(':generos_id', $libro[3], PDO::PARAM_STR, 45);
                $stmt->bindParam(':stock', $libro[4], PDO::PARAM_STR, 30);
                $stmt->bindParam(':precio', $libro[5], PDO::PARAM_STR, 9);
                $stmt->bindParam(':fecha_edicion', $libro[6], PDO::PARAM_STR);
                $stmt->bindParam(':isbn', $libro[7], PDO::PARAM_INT);
