...
if (isset($_SESSION['num_visitas_home'])) { //  Si la variable ya existe (si ya ha visitado la página)
    $_SESSION['num_visitas_home']++;    //  Se incrementa un contador de visitas cada vez que el usuario navegue por la página
} else {    //  Si la variable no existe, es la primera vez que se visita la página
    $_SESSION['num_visitas_home'] = 1;  //  Se inicializa el contador
}
